    ...
    <body class="">
        ...
        <section id="nav-expand">
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="#about" class="nav-one scrollLink">
                        <h2 class="hover"><span class="nav-span-active">01.</span>About</h2>
                    </a>
                </li><!-- nav-item -->
                <li class="nav-item">
        ...
        <section id="video" class="section-info">
            <div class="container">
        ...
        <section class="section-info" id="contact">
            <div class="container">
                <h2 class="section-lead">Get Involved</h2>
                      ...
                      <h3>Get in touch!</h3>
                       <span class="input input--hoshi">
                        ...
                        <span class="input input--hoshi">
                         ...
                         <span class="input input--hoshi">
                            <textarea class="input__field input__field--hoshi" type="text" id="input-4" rows="4" cols="50">
                             </textarea>
                            <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
